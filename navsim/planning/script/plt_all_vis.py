...
agent = ReCogDriveAgent(
    ...
    checkpoint_path="/data2/data_fusion/work/recogdrive/navsim_workspace/checkpoint/ReCogDrive_Diffusion_Planner_2B_RL.ckpt",
    vlm_path="/data2/data_fusion/work/recogdrive/navsim_workspace/checkpoint/ReCogDrive_VLM_2B",
    cam_type='single',
    vlm_type='internvl',
    dit_type='small',
...
metric_cache_loader = MetricCacheLoader(
    Path("/data2/data_fusion/work/recogdrive/navsim_workspace/exp/metric_cache")
)
...
# file_path = "/data2/data_fusion/work/recogdrive/navsim_workspace/exp/recogdrive_agent_eval/2026.04.05.17.04.15/2026.04.05.17.27.46.csv"
file_path = "/data2/data_fusion/work/recogdrive/navsim_workspace/exp/recogdrive_agent_eval_feedback_sup/2026.06.06.20.34.50/2026.06.06.20.50.33.csv"
