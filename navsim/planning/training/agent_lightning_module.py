...
class AgentLightningModule(pl.LightningModule):
    ...
    def on_save_checkpoint(self, checkpoint: Dict[str, Any]) -> None:
        ...
        filtered_sd = {
            ...
            and not k.startswith('agent.feedback_backbone')
        }
...
class AgentLightningDiT(pl.LightningModule):
    ...
    def on_train_epoch_end(self) -> None:
        planner = getattr(self.agent, "action_head", None)
        if planner is not None and hasattr(planner, "print_training_health"):
            planner.print_training_health()
